...
from reflex_local_auth.pages.components import MIN_WIDTH, input_100w

from .state import CustomRegisterState
...
def custom_register_form() -> rx.Component:
    ...
    return rx.form(
        ...
        on_submit=CustomRegisterState.handle_registration_email,
    )
